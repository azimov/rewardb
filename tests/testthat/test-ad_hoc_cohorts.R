...
test_that("Full data generation and export", {
  ...
  resultsFiles <- sccAdHocCohorts(cdmConfigPath, configFilePath, configId, atlasIds = atlasId, sourceUrl = config$webApiUrl)
  ...
  sccAdHocCohorts(cdmConfigPath, configFilePath, configId, atlasIds = atlasExposureId, sourceUrl = config$webApiUrl, exposure = TRUE)
